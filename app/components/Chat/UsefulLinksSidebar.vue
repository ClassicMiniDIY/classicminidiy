  ...
  <div v-if="links && links.length > 0" class="space-y-4">
    ...
    <div class="space-y-3">
      <a
        ...
        class="block p-3 rounded-lg bg-base-100 hover:border-primary/40 transition-colors border border-base-300 group"
        ...
        <div class="space-y-2">
          ...
          <div class="flex items-start justify-between gap-2">
            ...
            <div class="shrink-0 flex items-center gap-1">
              ...
              <i class="fas fa-arrow-up-right-from-square text-xs text-base-content/40"></i>
            </div>
          </div>

          <!-- Content Preview -->
          <p class="text-xs text-base-content/60 line-clamp-3 leading-relaxed">
            {{ link.content }}
          </p>
