      ...
      <div v-else-if="preferences">
        ...
        <div class="card bg-base-100 shadow mb-6">
          <div class="card-body">
            ...
            <div class="pt-2">
              <NuxtLink to="/dashboard/saved-searches" class="btn btn-ghost btn-sm">{{
                t('savedSearches.manageLink')
              }}</NuxtLink>
            </div>
          </div>
        </div>
...
<i18n lang="json">
{
  "en": {
    ...
    "header": {
      ...
      "subtitle": "Manage how you receive updates from The Mini Exchange"
    },
    "messages": {
      "title": "Messages",
      "emailNew": {
        "title": "Email notifications for new messages",
    ...
    "listings": {
      ...
      "status": {
        ...
        "description": "Get notified about approval, rejection, or expiration of your listings"
      },
    ...
    "savedSearches": {
      ...
      "matches": {
        ...
        "description": "Get notified when a new listing matches one of your saved searches"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Receive a weekly email with new listings and marketplace highlights"
      }
    },
  ...
  "es": {
    ...
    "header": {
      ...
      "subtitle": "Gestiona cómo recibes las novedades de The Mini Exchange"
    },
    "messages": {
      "title": "Mensajes",
      "emailNew": {
        "title": "Notificaciones por correo para nuevos mensajes",
        "description": "Recibe un aviso cuando alguien te envíe un mensaje"
      },
      "pushNew": {
    ...
    "listings": {
      "title": "Anuncios",
      "status": {
        "title": "Actualizaciones de estado del anuncio",
        "description": "Recibe avisos sobre aprobación, rechazo o caducidad de tus anuncios"
      },
      "newComments": {
        "title": "Nuevos comentarios",
        "description": "Recibe un aviso cuando alguien comente tu anuncio"
      },
      "commentReplies": {
        "title": "Respuestas a comentarios",
        "description": "Recibe un aviso cuando alguien responda a tu comentario"
      }
    },
    "savedSearches": {
      "title": "Búsquedas guardadas",
      "matches": {
        "title": "Nuevas coincidencias de anuncios",
        "description": "Recibe un aviso cuando un nuevo anuncio coincida con una de tus búsquedas guardadas"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Recibe un correo semanal con nuevos anuncios y novedades del mercado"
      }
    },
  ...
  "fr": {
    ...
    "header": {
      ...
      "subtitle": "Gérez la façon dont vous recevez les nouveautés de The Mini Exchange"
    },
    "messages": {
      "title": "Messages",
      "emailNew": {
        "title": "Notifications par e-mail pour les nouveaux messages",
        "description": "Soyez averti lorsque quelqu'un vous envoie un message"
      },
      "pushNew": {
    ...
    "listings": {
      "title": "Annonces",
      "status": {
        "title": "Mises à jour du statut des annonces",
        "description": "Soyez averti de l'approbation, du rejet ou de l'expiration de vos annonces"
      },
      "newComments": {
        "title": "Nouveaux commentaires",
        "description": "Soyez averti lorsque quelqu'un commente votre annonce"
      },
      "commentReplies": {
        "title": "Réponses aux commentaires",
        "description": "Soyez averti lorsque quelqu'un répond à votre commentaire"
      }
    },
    "savedSearches": {
      "title": "Recherches enregistrées",
      "matches": {
        "title": "Nouvelles annonces correspondantes",
        "description": "Soyez averti lorsqu'une nouvelle annonce correspond à l'une de vos recherches enregistrées"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Recevez un e-mail hebdomadaire avec les nouvelles annonces et les temps forts du marché"
      }
    },
  ...
  "de": {
    ...
    "header": {
      ...
      "subtitle": "Lege fest, wie du Neuigkeiten von The Mini Exchange erhältst"
    },
    "messages": {
      "title": "Nachrichten",
      "emailNew": {
        "title": "E-Mail-Benachrichtigungen für neue Nachrichten",
        "description": "Werde benachrichtigt, wenn dir jemand eine Nachricht sendet"
      },
      "pushNew": {
    ...
    "listings": {
      "title": "Anzeigen",
      "status": {
        "title": "Statusaktualisierungen der Anzeige",
        "description": "Werde über Freigabe, Ablehnung oder Ablauf deiner Anzeigen benachrichtigt"
      },
      "newComments": {
        "title": "Neue Kommentare",
        "description": "Werde benachrichtigt, wenn jemand deine Anzeige kommentiert"
      },
      "commentReplies": {
        "title": "Kommentarantworten",
        "description": "Werde benachrichtigt, wenn jemand auf deinen Kommentar antwortet"
      }
    },
    "savedSearches": {
      "title": "Gespeicherte Suchen",
      "matches": {
        "title": "Neue passende Anzeigen",
        "description": "Werde benachrichtigt, wenn eine neue Anzeige zu einer deiner gespeicherten Suchen passt"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Erhalte eine wöchentliche E-Mail mit neuen Anzeigen und Marktplatz-Highlights"
      }
    },
  ...
  "it": {
    ...
    "header": {
      ...
      "subtitle": "Gestisci come ricevi gli aggiornamenti da The Mini Exchange"
    },
    "messages": {
      "title": "Messaggi",
      "emailNew": {
        "title": "Notifiche email per nuovi messaggi",
        "description": "Ricevi un avviso quando qualcuno ti invia un messaggio"
      },
      "pushNew": {
    ...
    "listings": {
      "title": "Annunci",
      "status": {
        "title": "Aggiornamenti sullo stato dell'annuncio",
        "description": "Ricevi avvisi su approvazione, rifiuto o scadenza dei tuoi annunci"
      },
      "newComments": {
        "title": "Nuovi commenti",
        "description": "Ricevi un avviso quando qualcuno commenta il tuo annuncio"
      },
      "commentReplies": {
        "title": "Risposte ai commenti",
        "description": "Ricevi un avviso quando qualcuno risponde al tuo commento"
      }
    },
    "savedSearches": {
      "title": "Ricerche salvate",
      "matches": {
        "title": "Nuovi annunci corrispondenti",
        "description": "Ricevi un avviso quando un nuovo annuncio corrisponde a una delle tue ricerche salvate"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Ricevi un'email settimanale con nuovi annunci e novità del mercato"
      }
    },
  ...
  "pt": {
    ...
    "header": {
      ...
      "subtitle": "Gerencie como você recebe atualizações do The Mini Exchange"
    },
    "messages": {
      "title": "Mensagens",
      "emailNew": {
        "title": "Notificações por e-mail para novas mensagens",
        "description": "Seja avisado quando alguém te enviar uma mensagem"
      },
      "pushNew": {
    ...
    "listings": {
      "title": "Anúncios",
      "status": {
        "title": "Atualizações de status do anúncio",
        "description": "Seja avisado sobre aprovação, rejeição ou expiração dos seus anúncios"
      },
      "newComments": {
        "title": "Novos comentários",
        "description": "Seja avisado quando alguém comentar no seu anúncio"
      },
      "commentReplies": {
        "title": "Respostas a comentários",
        "description": "Seja avisado quando alguém responder ao seu comentário"
      }
    },
    "savedSearches": {
      "title": "Buscas salvas",
      "matches": {
        "title": "Novas correspondências de anúncios",
        "description": "Seja avisado quando um novo anúncio corresponder a uma das suas buscas salvas"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Receba um e-mail semanal com novos anúncios e destaques do mercado"
      }
    },
  ...
  "ru": {
    ...
    "header": {
      ...
      "subtitle": "Управляйте тем, как вы получаете обновления от The Mini Exchange"
    },
    "messages": {
      "title": "Сообщения",
      "emailNew": {
        "title": "Уведомления по эл. почте о новых сообщениях",
        "description": "Получайте уведомление, когда кто-то отправляет вам сообщение"
      },
      "pushNew": {
    ...
    "listings": {
      "title": "Объявления",
      "status": {
        "title": "Обновления статуса объявления",
        "description": "Получайте уведомления об одобрении, отклонении или истечении срока ваших объявлений"
      },
      "newComments": {
        "title": "Новые комментарии",
        "description": "Получайте уведомление, когда кто-то комментирует ваше объявление"
      },
      "commentReplies": {
        "title": "Ответы на комментарии",
        "description": "Получайте уведомление, когда кто-то отвечает на ваш комментарий"
      }
    },
    "savedSearches": {
      "title": "Сохранённые поиски",
      "matches": {
        "title": "Новые подходящие объявления",
        "description": "Получайте уведомление, когда новое объявление совпадает с одним из ваших сохранённых поисков"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        ...
        "description": "Получайте еженедельное письмо с новыми объявлениями и главными событиями маркетплейса"
      }
    },
  ...
  "ja": {
    ...
    "messages": {
      ...
      "emailNew": {
        "title": "新着メッセージのメール通知",
        "description": "誰かがメッセージを送ったときに通知を受け取ります"
      },
      "pushNew": {
    ...
    "listings": {
      ...
      "status": {
        "title": "出品ステータスの更新",
        "description": "出品の承認、却下、期限切れについて通知を受け取ります"
      },
      "newComments": {
        "title": "新着コメント",
        "description": "誰かがあなたの出品にコメントしたときに通知を受け取ります"
      },
      "commentReplies": {
        "title": "コメントへの返信",
        "description": "誰かがあなたのコメントに返信したときに通知を受け取ります"
      }
    },
    "savedSearches": {
      "title": "保存した検索",
      "matches": {
        "title": "新着の一致する出品",
        "description": "保存した検索のいずれかに一致する新着出品があったときに通知を受け取ります"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        "title": "週刊ニュースレター",
        "description": "新着出品とマーケットプレイスのハイライトをまとめた週刊メールを受け取ります"
      }
    },
  ...
  "ko": {
    ...
    "savedSearches": {
      ...
      "matches": {
        "title": "새로 일치하는 매물",
        "description": "저장된 검색 중 하나에 일치하는 새 매물이 있을 때 알림을 받습니다"
      },
    ...
    "digest": {
      ...
      "newsletter": {
        "title": "주간 뉴스레터",
        "description": "새 매물과 마켓플레이스 주요 소식을 담은 주간 이메일을 받습니다"
      }
    },
