...
<template>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="pb-12">
      <ToolFooter slug="chassis-decoder" />
    </div>
  </div>
</template>
...
{
  "en": {
    "title": "Mini VIN Decoder & Chassis Plate Lookup",
    "description": "Free Mini VIN decoder. Enter your Classic Mini chassis number to find the model, year, assembly plant and build sequence for Austin, Morris, Rover and Innocenti plates.",
    ...
    "hero_title": "Mini VIN Decoder",
    "breadcrumb_title": "Chassis Decoder",
    "og_title": "Mini VIN Decoder & Chassis Plate Lookup",
    "og_description": "Free Mini VIN decoder. Enter your Classic Mini chassis number to find the model, year, assembly plant and build sequence for Austin, Morris, Rover and Innocenti plates.",
    ...
    "main_heading": "Mini VIN & Chassis Plate Decoder",
  ...
  "es": {
    "title": "Decodificador de VIN Mini y Placa de Chasis",
    "description": "Decodificador de VIN Mini gratuito. Introduce el número de chasis de tu Classic Mini para conocer el modelo, año, planta de montaje y secuencia de fabricación de placas Austin, Morris, Rover e Innocenti.",
    ...
    "hero_title": "Decodificador de VIN Mini",
    "breadcrumb_title": "Decodificador de Chasis",
    "og_title": "Decodificador de VIN Mini y Placa de Chasis",
    "og_description": "Decodificador de VIN Mini gratuito. Introduce el número de chasis de tu Classic Mini para conocer el modelo, año, planta de montaje y secuencia de fabricación de placas Austin, Morris, Rover e Innocenti.",
    ...
    "main_heading": "Decodificador de VIN y Placa de Chasis Mini",
  ...
  "fr": {
    "title": "Décodeur VIN Mini et Plaque de Châssis",
    "description": "Décodeur VIN Mini gratuit. Saisissez le numéro de châssis de votre Classic Mini pour connaître le modèle, l'année, l'usine d'assemblage et le numéro de série des plaques Austin, Morris, Rover et Innocenti.",
    ...
    "hero_title": "Décodeur VIN Mini",
    "breadcrumb_title": "Décodeur de Châssis",
    "og_title": "Décodeur VIN Mini et Plaque de Châssis",
    "og_description": "Décodeur VIN Mini gratuit. Saisissez le numéro de châssis de votre Classic Mini pour connaître le modèle, l'année, l'usine d'assemblage et le numéro de série des plaques Austin, Morris, Rover et Innocenti.",
    ...
    "main_heading": "Décodeur VIN et Plaque de Châssis Mini",
  ...
  "it": {
    "title": "Decodificatore VIN Mini e Targhetta Telaio",
    "description": "Decodificatore VIN Mini gratuito. Inserisci il numero di telaio della tua Classic Mini per scoprire modello, anno, stabilimento e numero progressivo delle targhette Austin, Morris, Rover e Innocenti.",
    ...
    "hero_title": "Decodificatore VIN Mini",
    "breadcrumb_title": "Decodificatore Telaio",
    "og_title": "Decodificatore VIN Mini e Targhetta Telaio",
    "og_description": "Decodificatore VIN Mini gratuito. Inserisci il numero di telaio della tua Classic Mini per scoprire modello, anno, stabilimento e numero progressivo delle targhette Austin, Morris, Rover e Innocenti.",
    ...
    "main_heading": "Decodificatore VIN e Targhetta Telaio Mini",
  ...
  "de": {
    "title": "Mini VIN-Decoder & Fahrgestellnummer",
    "description": "Kostenloser Mini VIN-Decoder. Gib die Fahrgestellnummer deines Classic Mini ein und erhalte Modell, Baujahr, Montagewerk und Seriennummer für Austin-, Morris-, Rover- und Innocenti-Schilder.",
    ...
    "og_title": "Mini VIN-Decoder & Fahrgestellnummer",
    "og_description": "Kostenloser Mini VIN-Decoder. Gib die Fahrgestellnummer deines Classic Mini ein und erhalte Modell, Baujahr, Montagewerk und Seriennummer für Austin-, Morris-, Rover- und Innocenti-Schilder.",
    ...
    "main_heading": "Mini VIN- & Fahrgestellnummer-Decoder",
  ...
  "pt": {
    "title": "Descodificador de VIN Mini e Placa de Chassis",
    "description": "Descodificador de VIN Mini gratuito. Introduza o número de chassis do seu Classic Mini para saber o modelo, ano, fábrica de montagem e sequência de produção das placas Austin, Morris, Rover e Innocenti.",
    ...
    "hero_title": "Descodificador de VIN Mini",
    "breadcrumb_title": "Decodificador de Chassi",
    "og_title": "Descodificador de VIN Mini e Placa de Chassis",
    "og_description": "Descodificador de VIN Mini gratuito. Introduza o número de chassis do seu Classic Mini para saber o modelo, ano, fábrica de montagem e sequência de produção das placas Austin, Morris, Rover e Innocenti.",
    ...
    "main_heading": "Descodificador de VIN e Placa de Chassis Mini",
  ...
  "ru": {
    "title": "Декодер VIN Mini и таблички шасси",
    "description": "Бесплатный декодер VIN Mini. Введите номер шасси вашего Classic Mini, чтобы узнать модель, год, завод сборки и порядковый номер для табличек Austin, Morris, Rover и Innocenti.",
    ...
    "hero_title": "Декодер VIN Mini",
    "breadcrumb_title": "Декодер шасси",
    "og_title": "Декодер VIN Mini и таблички шасси",
    "og_description": "Бесплатный декодер VIN Mini. Введите номер шасси вашего Classic Mini, чтобы узнать модель, год, завод сборки и порядковый номер для табличек Austin, Morris, Rover и Innocenti.",
    ...
    "main_heading": "Декодер VIN и таблички шасси Mini",
  ...
  "ja": {
    "title": "Mini VINデコーダー・シャシープレート検索",
    "description": "無料のMini VINデコーダー。Classic Miniのシャシー番号を入力すると、Austin、Morris、Rover、Innocentiのプレートからモデル、年式、組立工場、製造連番がわかります。",
    "keywords": "シャシーデコーダー, クラシックミニ VIN, シャシープレート, ミニクーパー VINデコーダー, シャシー番号検索, ミニ識別, ビルド番号デコーダー",
    "hero_title": "Mini VINデコーダー",
    "breadcrumb_title": "シャシーデコーダー",
    "og_title": "Mini VINデコーダー・シャシープレート検索",
    "og_description": "無料のMini VINデコーダー。Classic Miniのシャシー番号を入力すると、Austin、Morris、Rover、Innocentiのプレートからモデル、年式、組立工場、製造連番がわかります。",
    "twitter_title": "Tech - ミニ シャシープレート デコーダー",
    "twitter_description": "クラシックミニのシャシープレートをデコードして、モデルイヤー、組立工場、車両の連番ビルド番号を確認できます。",
    "main_heading": "Mini VIN・シャシープレートデコーダー",
  ...
  "zh": {
    "title": "Mini VIN解码器与底盘铭牌查询",
    "description": "免费Mini VIN解码器。输入您的Classic Mini底盘号，即可查询Austin、Morris、Rover和Innocenti铭牌的车型、年份、装配厂和生产序号。",
    "keywords": "底盘解码器, 经典迷你VIN, 底盘铭牌, 迷你库珀VIN解码器, 底盘号查询, 迷你识别, 生产编号解码器",
    "hero_title": "Mini VIN解码器",
    "breadcrumb_title": "底盘解码器",
    "og_title": "Mini VIN解码器与底盘铭牌查询",
    "og_description": "免费Mini VIN解码器。输入您的Classic Mini底盘号，即可查询Austin、Morris、Rover和Innocenti铭牌的车型、年份、装配厂和生产序号。",
    "twitter_title": "Tech - 迷你底盘铭牌解码器",
    "twitter_description": "解码您的经典迷你的底盘铭牌，以确定车辆的生产年份、装配工厂和顺序生产编号。",
    "main_heading": "Mini VIN与底盘铭牌解码器",
  ...
  "ko": {
    "title": "Mini VIN 디코더 및 섀시 플레이트 조회",
    "description": "무료 Mini VIN 디코더. Classic Mini 섀시 번호를 입력하면 Austin, Morris, Rover, Innocenti 플레이트의 모델, 연식, 조립 공장, 생산 순번을 확인할 수 있습니다.",
    "keywords": "섀시 디코더, 클래식 미니 VIN, 섀시 플레이트, 미니 쿠퍼 VIN 디코더, 섀시 번호 조회, 미니 식별, 생산 번호 디코더",
    "hero_title": "Mini VIN 디코더",
    "breadcrumb_title": "섀시 디코더",
    "og_title": "Mini VIN 디코더 및 섀시 플레이트 조회",
    "og_description": "무료 Mini VIN 디코더. Classic Mini 섀시 번호를 입력하면 Austin, Morris, Rover, Innocenti 플레이트의 모델, 연식, 조립 공장, 생산 순번을 확인할 수 있습니다.",
    "twitter_title": "Tech - 미니 섀시 플레이트 디코더",
    "twitter_description": "클래식 미니의 섀시 플레이트를 디코딩하여 모델 연도, 조립 공장 및 차량의 순차 생산 번호를 확인하세요.",
    "main_heading": "Mini VIN 및 섀시 플레이트 디코더",
