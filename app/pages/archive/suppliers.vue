<script lang="ts" setup>
  ...
  useSeoMeta({
    ...
    ogType: 'website',
    ogImage: 'https://classicminidiy.s3.amazonaws.com/social-share/archive/suppliers.png',
    twitterCard: 'summary_large_image',
    twitterTitle: t('heading'),
    twitterDescription: t('description'),
    twitterImage: 'https://classicminidiy.s3.amazonaws.com/social-share/archive/suppliers.png',
  });
