<script setup lang="ts">
  ...
  const getArchiveItemTitle = (title: string) => {
    const titleMap: { [key: string]: string } = {
      ...
      'Model Variants': 'archive_items.model_variants',
...
<i18n lang="json">
{
  "en": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "Every Mini ever built, 1959–2000, with factory specs, production numbers and colours.",
  ...
  "es": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "Todos los Mini fabricados, 1959–2000, con especificaciones de fábrica, producción y colores.",
  ...
  "fr": {
    ...
    "archive_items": {
      ...
      "model_variants": "Variantes de modèle",
      ...
      "model_variants_desc": "Toutes les Mini produites, 1959–2000, avec fiches techniques, chiffres de production et couleurs.",
  ...
  "it": {
    ...
    "archive_items": {
      ...
      "model_variants": "Varianti di modello",
      ...
      "model_variants_desc": "Tutte le Mini mai costruite, 1959–2000, con schede tecniche, produzione e colori.",
  ...
  "de": {
    ...
    "archive_items": {
      ...
      "model_variants": "Modellvarianten",
      ...
      "model_variants_desc": "Jeder je gebaute Mini, 1959–2000, mit Werksdaten, Stückzahlen und Farben.",
  ...
  "pt": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "Todos os Mini construídos, 1959–2000, com especificações de fábrica, produção e cores.",
  ...
  "ru": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "Все выпущенные Mini, 1959–2000, с заводскими характеристиками, тиражом и цветами.",
  ...
  "ja": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "1959〜2000年に生産された全Mini。工場スペック、生産台数、カラー付き。",
  ...
  "zh": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "1959–2000年生产的所有Mini，含原厂参数、产量和颜色。",
  ...
  "ko": {
    ...
    "archive_items": {
      ...
      "model_variants_desc": "1959–2000년 생산된 모든 Mini, 공장 제원, 생산 대수 및 색상 포함.",
