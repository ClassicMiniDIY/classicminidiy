...
put NUXT_TYPESAFE_SEARCH_MODE NUXT_TYPESAFE_SEARCH_MODE OPTIONAL
put NUXT_TYPESAFE_QUEUE_MODE NUXT_TYPESAFE_QUEUE_MODE OPTIONAL
put NUXT_TYPESAFE_MCP_MODE NUXT_TYPESAFE_MCP_MODE OPTIONAL
