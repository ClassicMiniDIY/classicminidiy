...
import type { TireCalculationResult, GearingTableRow } from '~/app/utils/gearingCalculations';
...
// ---------------------------------------------------------------------------
// calculateChartData — REMOVED from source; tests kept as skipped reference
// ---------------------------------------------------------------------------
// The calculateChartData function was removed from gearingCalculations.ts.
