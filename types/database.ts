...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      listings: {
        Row: {
          ...
          city: string | null;
          color: string | null;
          condition: Database['public']['Enums']['listing_condition_enum'] | null;
          country: string | null;
          created_at: string | null;
          currency: string | null;
          dashboard_type: Database['public']['Enums']['dashboard_type_enum'] | null;
          description: string;
          ...
          engine_series: Database['public']['Enums']['engine_series_enum'] | null;
          ...
          listing_category: Database['public']['Enums']['listing_category_enum'] | null;
          ...
          mileage: number | null;
          model: string | null;
          oem_or_aftermarket: Database['public']['Enums']['oem_or_aftermarket_enum'] | null;
          original_color: string | null;
          other_modifications: string | null;
          package_dimensions: string | null;
          package_weight_kg: number | null;
          paid_amount: number | null;
          part_condition: Database['public']['Enums']['part_condition_enum'] | null;
          ...
          steering_wheel_type: Database['public']['Enums']['steering_wheel_type_enum'] | null;
      ...
      part_applicability: {
        ...
        Relationships: [
          {
            foreignKeyName: 'part_applicability_part_id_fkey';
            columns: ['part_id'];
            isOneToOne: false;
      ...
      part_change_log: {
        ...
        Relationships: [
          {
            foreignKeyName: 'part_change_log_run_id_fkey';
            columns: ['run_id'];
            isOneToOne: false;
            referencedRelation: 'part_ingest_runs';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'part_change_log_source_record_id_fkey';
            columns: ['source_record_id'];
            isOneToOne: false;
            referencedRelation: 'part_source_records';
            referencedColumns: ['id'];
          },
        ];
      };
      part_diagram_callouts: {
        Row: {
          callout_number: string;
          created_at: string;
          description_as_printed: string | null;
          diagram_id: string;
          hotspot: Json | null;
          id: string;
          notes: string | null;
          part_id: string | null;
          part_number_as_printed: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'part_diagram_callouts_diagram_id_fkey';
            columns: ['diagram_id'];
            isOneToOne: false;
            referencedRelation: 'part_diagrams';
            referencedColumns: ['id'];
          },
          {
            foreignKeyName: 'part_diagram_callouts_part_id_fkey';
            columns: ['part_id'];
            isOneToOne: false;
            referencedRelation: 'parts';
            referencedColumns: ['id'];
      ...
      part_kit_contents: {
        ...
        Relationships: [
          {
            foreignKeyName: 'part_kit_contents_component_part_id_fkey';
          ...
          {
            foreignKeyName: 'part_kit_contents_kit_part_id_fkey';
            columns: ['kit_part_id'];
            isOneToOne: false;
            referencedRelation: 'parts';
            referencedColumns: ['id'];
      ...
      part_number_correlations: {
        ...
        Relationships: [
          {
            foreignKeyName: 'part_number_correlations_part_id_fkey';
            columns: ['part_id'];
            isOneToOne: false;
            referencedRelation: 'parts';
            referencedColumns: ['id'];
          ...
          {
            foreignKeyName: 'part_number_correlations_source_record_id_fkey';
            columns: ['source_record_id'];
            isOneToOne: false;
            referencedRelation: 'part_source_records';
            referencedColumns: ['id'];
      ...
      part_source_private: {
        Row: {
          ...
          refusal_alerted_at: string | null;
          robots_fetched_at: string | null;
          robots_host: string | null;
      ...
      part_source_records: {
        ...
        Relationships: [
          {
            foreignKeyName: 'part_source_records_part_id_fkey';
            columns: ['part_id'];
            isOneToOne: false;
            referencedRelation: 'parts';
            referencedColumns: ['id'];
      ...
      part_supersessions: {
        ...
        Relationships: [
          {
            foreignKeyName: 'part_supersessions_predecessor_id_fkey';
          ...
          {
            foreignKeyName: 'part_supersessions_successor_id_fkey';
    ...
    Functions: {
      ...
      close_abandoned_part_ingest_runs: {
        Args: { p_older_than_seconds?: number; p_source_id: string };
        Returns: number;
      };
      consume_chat_quota: {
    ...
    Enums: {
      ...
      bumper_type_enum: 'chrome_standard' | 'chrome_overriders' | 'plastic' | 'deleted';
      carb_type_enum: 'single_su' | 'twin_su' | 'weber' | 'stromberg' | 'fuel_injection' | 'other';
      contribution_action_enum: 'submitted' | 'edited' | 'approved' | 'rejected';
      dashboard_type_enum: 'standard' | 'wood_veneer' | 'rally' | 'carbon_fiber' | 'other';
      document_type_enum: 'manual' | 'advert' | 'catalogue' | 'tuning' | 'electrical';
      engine_series_enum: 'A-Series' | 'A+-Series';
      exhaust_type_enum: 'standard' | 'sportex' | 'maniflow' | 'stainless' | 'custom' | 'other';
      gearbox_type_enum: 'magic_wand' | '3_synchro_remote' | '4_synchro_remote' | 'rod_change' | 'automatic';
      ...
      listing_condition_enum:
        ...
        | 'parts_only';
      listing_status_enum:
        'draft' | 'pending' | 'active' | 'sold' | 'expired' | 'cancelled' | 'example_free' | 'example_paid';
      listing_tier_enum: 'free' | 'paid';
      listing_type_enum: 'fixed_price';
      maintenance_instance_status: 'incomplete' | 'partially_complete' | 'completed';
      manufacturer_enum: 'morris' | 'austin' | 'rover' | 'leyland' | 'innocenti' | 'wolseley' | 'riley' | 'other';
      moderation_status_enum: 'draft' | 'pending' | 'approved' | 'rejected' | 'changes_requested';
      oem_or_aftermarket_enum: 'oem' | 'aftermarket' | 'reproduction';
      part_condition_enum: 'new' | 'used_excellent' | 'used_good' | 'used_fair' | 'rebuild' | 'core';
      parts_subcategory_enum:
        'body_exterior' | 'interior' | 'wheels_tires' | 'engine_internals' | 'suspension' | 'electrical' | 'other';
      payment_status_enum: 'pending' | 'paid' | 'refunded';
      restoration_status_enum: 'original' | 'partially_restored' | 'fully_restored' | 'restomod' | 'project' | 'scrap';
      rust_condition_enum: 'none_visible' | 'minor_surface' | 'moderate' | 'significant';
      seat_type_enum: 'original' | 'cobra' | 'recaro' | 'cooper_s' | 'custom' | 'other';
      ...
      vehicle_color:
        ...
        | 'forest'
        | 'crimson';
      wheel_type_enum: 'standard' | 'minilite' | 'cooper_s' | 'revolution' | 'rose_petal' | 'other';
