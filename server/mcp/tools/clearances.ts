...
export default defineMcpTool({
  ...
  async handler({ query, section, limit }, extra) {
    ...
    const pick = await pickRelated(eventFromExtra(extra), 'clearances', 'component', query, result.related);
    ...
    const note = result.related.length ? relatedNote('component', pickNote) : undefined;
